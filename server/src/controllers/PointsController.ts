...
class PointsCrontroller {
    async index(request:Request, response:Response){
        // filtros: cidade, uf, itens (query params)
    ...
    async show(request: Request, response: Response){
        ...
        // pega todos os itens relacionados ao ponto de coleta pedido
    ...
    async create(request: Request, response: Response){
        ...
        //TRANSACTION: caso dê erro numa transição anterior, ele não continua e dá rollback
